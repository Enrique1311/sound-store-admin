...
// 			<Link
// 				href={"/"}
// 				className="flex gap-3 mb-4 mr-4"
// 			>
// 				<span className="font-bold text-xl">Ecommerce (Administrador)</span>
// 			</Link>
...
// 					href={"/productsList"}
// 					className={
// 						pathname.includes("/productsList") ? activeLink : inactiveLink
// 					}
// 				>
// 					{" "}
// 					<svg
...
// 	const activeLink = inactiveLink + " bg-orange-500 text-black rounded-sm";
// 	const inactiveIcon = "w-6 h-6";
// 	const activeIcon = inactiveIcon + " text-black font-bold";
// 	const router = useRouter();
// 	const { pathname } = router;
...
// 				" top-0 text-white p-4 fixed w-full bg-orange-500 h-full md:static md:w-auto transition-all"
// 			}
// 		>
...
export default function Navbar({ show }) {
	const inactiveLink = "flex gap-1 p-1";
	const activeLink = inactiveLink + " bg-orange-500 text-white rounded-md";
	const inactiveIcon = "w-6 h-6";
			...
			<nav className="flex flex-col gap-2">
				...
				>
					<svg
						...
						stroke="currentColor"
						className={
							pathname.includes("/productsList") ? activeIcon : inactiveIcon
						}
					>
						<path
							strokeLinecap="round"
